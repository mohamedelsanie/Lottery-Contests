	...
	<div class="center_om clearfix">
		<div class="container">
			<div class="row center_o1">
				<div class="col-md-12">
					<h2 class="text-white">{{ __('front/common.finish_title') }}</h2>
					<h6 class="mb-0 mt-3 fw-normal col_oran">
                        <a class="text-light" href="{{ route('homepage') }}">{{ __('front/common.home') }}</a> 
                        <span class="mx-2 col_light">/</span> {{ __('front/common.finish_title') }}</h6>
				</div>
			</div>
		</div>
	</div>
					...
					<div class="row">
                        <!---->
							 ...
							 <div class="join-form position-relative">
                                <button class="print-btn btn btn-primary position-absolute" onclick="window.print();">{{ __('front/common.finish_print') }}</button>
                                <h2 class="text-center text-secondary mb-5">{{ __('front/common.finish_details') }}</h2>
                                <div class="Details">
                                    ...
                                    <p class="h6 text-dark mt-4">{{ __('front/common.finish_notic') }}</p>
                                    <p class="h6 text-dark mt-4">{{ __('front/common.finish_follow') }}  <a href="{{ route('tours.check') }}">{{ __('front/common.finish_clickhere') }}</a></p>
 ...
 <div class="row ride_1">
  ...
  <div class="col-md-4">
   <div class="ride_1r mt-4 text-end">
    ...
    @section('page_title'){{ __('front/post_types.tours.title') }} - تفاصيل الإشتراك @endsection
</x-app-layout>