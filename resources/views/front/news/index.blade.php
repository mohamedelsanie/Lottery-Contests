	...
	<div class="center_om clearfix">
		<div class="container">
			<div class="row center_o1">
				<div class="col-md-12">
					<h2 class="text-white">{{ __('front/post_types.posts.title') }}</h2>
					<h6 class="mb-0 mt-3 fw-normal col_oran"><a class="text-light" href="{{ route('homepage') }}">{{ __('front/common.home') }}</a> <span class="mx-2 col_light">/</span> {{ __('front/post_types.posts.title') }}</h6>
				</div>
			</div>
		</div>
	</div>
