        ...
        <div class="page-header mb-0">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    ...
                    <a href="{{ route('admin.orders.contest_export',$contest_id) }}" class="btn btn-primary btn-sm scroll-click">{{ __('admin/order.index.download') }}</a>
                    @endif
                </div>
            </div>
        </div>
                            ...
                            @foreach($pages as $page)
                                <tr>
                                    ...
                                    <td>
                                        <div class="name-avatar d-flex align-items-center">
                                            <div class="txt">
                                                <div class="weight-600">{{ $page->contest->title }}</div>
                                            </div>
                                        </div>
                                    </td>
