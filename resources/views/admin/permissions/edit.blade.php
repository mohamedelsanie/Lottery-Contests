                ...
                <form action="{{ route('admin.permissions.update', $permission->id) }}" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input name="name" placeholder="{{ __('admin/permission.fields.title') }}" value="{{ $permission->name }}" class="border-gray-300 rounded-md shadow-sm form-control @error('name') border border-danger @enderror" type="text"/>
