                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12 col-md-12">
                                            <select name="mode" id="mode_type" class="border-gray-300 rounded-md shadow-sm custom-select col-12 @error('mode') border border-danger @enderror">
                                                <option  @if(old('mode') == '') selected @endif>{{ __('admin/user.fields.choose') }}</option>
                                                <option value="regular" @if(old('mode') == 'regular') selected @endif>{{ __('admin/user.fields.regular') }}</option>
                                                <option value="super" @if(old('mode') == 'super') selected @endif>{{ __('admin/user.fields.super') }}</option>
                                            </select>
                                            @error('mode')<span class="text-danger">{{ $message }}</span>@enderror
                                        </div>
                                    </div>

                                    <div class="form-group row exp_date" style="display: none">
                                        <label class="col-sm-12 col-md-12 col-form-label">{{ __('admin/user.fields.exp_date') }}</label>
                                        <div class="col-sm-12 col-md-12">
                                            <input name="exp_in" placeholder="{{ __('admin/user.fields.exp_date') }}" value="{{ old('exp_in') }}" class="border-gray-300 rounded-md shadow-sm date-picker2 form-control @error('exp_in') border border-danger @enderror" type="text"/>
