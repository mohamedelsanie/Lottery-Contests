                        ...
                        <div class="col-sm-12 col-md-4 mb-30">
                            ...
                            <div class="card card-box custom mb-10" id="accordionMode">
                                <div class="card-header" data-toggle="collapse" href="#collapseMode">
                                    <a class="card-title">
                                        {{ __('admin/user.fields.mode') }}
                                    </a>
                                </div>
                                <div id="collapseMode" class="card-body show" data-parent="#accordionMode" >
                                    <div class="form-group row">
                                        <div class="col-sm-12 col-md-12">
                                            <select name="mode" id="mode_type" class="border-gray-300 rounded-md shadow-sm custom-select col-12 @error('mode') border border-danger @enderror">
                                                @if($user->mode == 'regular')
                                                    <option value="regular" selected>{{ __('admin/user.fields.regular') }}</option>
                                                    <option value="super">{{ __('admin/user.fields.super') }}</option>
                                                @elseif($user->mode == 'super')
                                                    <option value="regular">{{ __('admin/user.fields.regular') }}</option>
                                                    <option value="super" selected>{{ __('admin/user.fields.super') }}</option>
                                                @else
                                    ...
                                    <div class="form-group row exp_date" @if($user->mode != 'super') style="display: none" @endif>
                                        <label class="col-sm-12 col-md-12 col-form-label">{{ __('admin/user.fields.exp_date') }}</label>
                                        <div class="col-sm-12 col-md-12">
                                            <input name="exp_in" placeholder="{{ __('admin/user.fields.exp_date') }}" value="{{ $user->exp_in }}" class="border-gray-300 rounded-md shadow-sm date-picker2 form-control @error('exp_in') border border-danger @enderror" type="text"/>
                                            @error('exp_in')<span class="text-danger">{{ $message }}</span>@enderror
                                        </div>
                                    </div>
