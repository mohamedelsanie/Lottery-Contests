...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/vendors/styles/icon-font.min.css') }}" />
		...
		<link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/src/plugins/jquery-asColorPicker/dist/css/asColorPicker.css') }}" />
...
<div class="main-container">
    ...
    <script src="{{ asset('assets/admin/src/plugins/jquery-asColor/dist/jquery-asColor.js') }}"></script>
    <script src="{{ asset('assets/admin/src/plugins/jquery-asColorPicker/jquery-asColorPicker.js') }}"></script>
    <script src="{{ asset('assets/admin/vendors/scripts/colorpicker.js') }}"></script>
