                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="tab-content" id="v-pills-tabContent">
                                            <div class="tab-pane fade shadow rounded bg-white show active p-5" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-sm-12 col-md-2 col-form-label">{{ __('admin/setting.fawry_code') }}</label>
                                                    <div class="col-sm-12 col-md-10">
                                                        <textarea name="fawry_code" placeholder="{{ __('admin/setting.fawry_code') }}" class="border-gray-300 rounded-md shadow-sm form-control @error('fawry_code') border border-danger @enderror">{{ $setting->fawry_code }}</textarea>
                                                        @error('fawry_code')<span class="text-danger">{{ $message }}</span>@enderror
                                                    </div>
                                                </div>
                                                
                                                <div class="form-group row">
                                                    <label class="col-sm-12 col-md-2 col-form-label">{{ __('admin/setting.vodafone_cash') }}</label>
                                                    <div class="col-sm-12 col-md-10">
                                                        <textarea name="vodafone_cash" placeholder="{{ __('admin/setting.vodafone_cash') }}" class="border-gray-300 rounded-md shadow-sm form-control @error('vodafone_cash') border border-danger @enderror">{{ $setting->vodafone_cash }}</textarea>
                                                        @error('vodafone_cash')<span class="text-danger">{{ $message }}</span>@enderror
                                                    </div>
                                                </div>
                                                                ...
                                                                <div class="tab-pane @if(LaravelLocalization::getCurrentLocale() == $key) active @endif" id="about_blocks-{{ $key }}" role="tabpanel">
                                                                    ...
                                                                    <table class="table table-bordered" id="about_table_{{ $key }}">
                                                                        <tr>
                                                                            ...
                                                                            <th>{{ __('admin/setting.about_blocks_desc') }}</th>
                                                                            <th>{{ __('admin/setting.about_blocks_link') }}</th>
                                                                            <th>{{ __('admin/setting.about_blocks_link_txt') }}</th>
                                                                        ...
                                                                        @if(!empty($about_slides))
                                                                            @if(is_array($about_slides))
                                                                                @for($i = 0; $i < count($about_slides[0]); $i++)
                                                                                    <tr>
                                                                                        <td><input type="text" name="{{ $key }}[about_blocks][title][]" value="{{ $about_slides[0][$i] }}" class="form-control" /></td>
                                                                                        <td><input type="text" name="{{ $key }}[about_blocks][desc][]" value="{{ $about_slides[1][$i] }}" class="form-control" /></td>
                                                                                        <td><input type="text" name="{{ $key }}[about_blocks][link][]" value="{{ $about_slides[2][$i] }}" class="form-control" /></td>
                                                                                        <td><input type="text" name="{{ $key }}[about_blocks][link_txt][]" value="{{ $about_slides[3][$i] }}" class="form-control" /></td>
...
-->
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-sm-12 col-md-2 col-form-label">{{ __('admin/setting.faqs_title') }}</label>
                                                    <div class="col-sm-12 col-md-10">
                                                        <ul class="nav nav-tabs" role="tablist">
                                                            @foreach(config('translatable.languages') as $key => $lang)
                                                                <li class="nav-item @if($errors->has($key.'*faqs_title'))  border border-danger @endif">
                                                                    <a class="nav-link @if(LaravelLocalization::getCurrentLocale() == $key) active @endif" data-toggle="tab" href="#faqs_title-{{ $key }}" role="tab">{{ $lang }}</a>
                                                                </li>
                                                            @endforeach
                                                        </ul><!-- Tab panes -->
                                                        <div class="tab-content">
                                                            @foreach(config('translatable.languages') as $key => $lang)
                                                                <div class="tab-pane @if(LaravelLocalization::getCurrentLocale() == $key) active @endif" id="faqs_title-{{ $key }}" role="tabpanel">
                                                                    <input name="{{ $key }}[faqs_title]" placeholder="{{ __('admin/setting.faqs_title') }}" value="{{ $setting->translate($key)->faqs_title }}" class="border-gray-300 rounded-md shadow-sm form-control @if($errors->has($key.'*faqs_title')) border border-danger @endif" type="text"/>
                                                                    @if($errors->has($key.'*faqs_title'))<span class="text-danger">{{ $errors->first($key.'*faqs_title') }}</span>@endif
                                                                </div>
                                                            @endforeach
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-sm-12 col-md-2 col-form-label">{{ __('admin/setting.faqs_desc') }}</label>
                                                    <div class="col-sm-12 col-md-10">
                                                        <ul class="nav nav-tabs" role="tablist">
                                                            @foreach(config('translatable.languages') as $key => $lang)
                                                                <li class="nav-item @if($errors->has($key.'*faqs_desc'))  border border-danger @endif">
                                                                    <a class="nav-link @if(LaravelLocalization::getCurrentLocale() == $key) active @endif" data-toggle="tab" href="#faqs_desc-{{ $key }}" role="tab">{{ $lang }}</a>
                                                                </li>
                                                            @endforeach
                                                        </ul><!-- Tab panes -->
                                                        <div class="tab-content">
                                                            @foreach(config('translatable.languages') as $key => $lang)
                                                                <div class="tab-pane @if(LaravelLocalization::getCurrentLocale() == $key) active @endif" id="faqs_desc-{{ $key }}" role="tabpanel">
                                                                    <input name="{{ $key }}[faqs_desc]" placeholder="{{ __('admin/setting.faqs_desc') }}" value="{{ $setting->translate($key)->faqs_desc }}" class="border-gray-300 rounded-md shadow-sm form-control @if($errors->has($key.'*faqs_desc')) border border-danger @endif" type="text"/>
                                                                    @if($errors->has($key.'*faqs_desc'))<span class="text-danger">{{ $errors->first($key.'*faqs_desc') }}</span>@endif
                                                                </div>
                                                            @endforeach
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-sm-12 col-md-2 col-form-label">{{ __('admin/setting.faqs_blocks') }}</label>
                                                    <div class="col-sm-12 col-md-10">
                                                        <ul class="nav nav-tabs" role="tablist">
                                                            @foreach(config('translatable.languages') as $key => $lang)
                                                                <li class="nav-item @if($errors->has($key.'*faqs_blocks'))  border border-danger @endif">
                                                                    <a class="nav-link @if(LaravelLocalization::getCurrentLocale() == $key) active @endif" data-toggle="tab" href="#faqs_blocks-{{ $key }}" role="tab">{{ $lang }}</a>
                                                                </li>
                                                            @endforeach
                                                        </ul><!-- Tab panes -->
                                                        <div class="tab-content">
                                                            @foreach(config('translatable.languages') as $key => $lang)
                                                                <div class="tab-pane @if(LaravelLocalization::getCurrentLocale() == $key) active @endif" id="faqs_blocks-{{ $key }}" role="tabpanel">

                                                                    <table class="table table-bordered" id="faqs_table_{{ $key }}">
                                                                        <tr>
                                                                            <th>{{ __('admin/setting.faqs_blocks_title') }}</th>
                                                                            <th>{{ __('admin/setting.faqs_blocks_desc') }}</th>
                                                                            <th><button type="button" class="btn btn-success btn-sm add_faqs_{{ $key }}" data-id="" style="background: green;"><span class="fa fa-plus"></span></button></th>
                                                                        </tr>
                                                                        @php
                                                                            $faqs = json_decode($setting->translate($key)->faqs_blocks, true);
                                                                            $faqs_slides = array_values($faqs);
                                                                        @endphp
                                                                        @if(!empty($faqs_slides))
                                                                            @if(is_array($faqs_slides))
                                                                                @for($i = 0; $i < count($faqs_slides[0]); $i++)
                                                                                    <tr>
                                                                                        <td><input type="text" name="{{ $key }}[faqs_blocks][title][]" value="{{ $faqs_slides[0][$i] }}" class="form-control" /></td>
                                                                                        <td><input type="text" name="{{ $key }}[faqs_blocks][desc][]" value="{{ $faqs_slides[1][$i] }}" class="form-control" /></td>
                                                                                        <td><button type="button" class="btn btn-danger btn-sm faqs_remove" style="background: red;"><span class="fa fa-minus"></span></button></td>
                                                                                    </tr>
                                                                                @endfor
                                                                            @endif
                                                                        @endif
                                                                    ...
                                                                    @if($errors->has($key.'*faqs_blocks'))<span class="text-danger">{{ $errors->first($key.'*faqs_blocks') }}</span>@endif
                                                                </div>
                                                            @endforeach
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="tab-pane fade shadow rounded bg-white p-5" id="v-pills-pages" role="tabpanel" aria-labelledby="v-pills-pages-tab">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-sm-12 col-md-2 col-form-label">{{ __('admin/setting.faqs_page') }}</label>
                                                    <div class="col-sm-12 col-md-10">
                                                    <select name="faqs_page" class="custom-select border-gray-300 rounded-md shadow-sm form-control @error('faqs_page') border border-danger @enderror">
                                                            @if(count($pages) > 0)
                                                                @foreach($pages as $page)
                                                                    <option value="{{ $page->id }}" @if($page->id == $setting->faqs_page) selected @endif >{{ $page->title }}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                        @error('faqs_page')<span class="text-danger">{{ $message }}</span>@enderror
                                                    </div>
                                                </div>
    ...
    @section('scripts')
        <script>
            ...
            $(document).on('click', '#about_table_ar .add_about_ar', function(){
                ...
                about_html_ar += '<td><input type="text" name="ar[about_blocks][desc][]" class="form-control" /></td>';
                about_html_ar += '<td><input type="text" name="ar[about_blocks][link][]" class="form-control" /></td>';
                about_html_ar += '<td><input type="text" name="ar[about_blocks][link_txt][]" class="form-control" /></td>';
            ...
            $(document).on('click', '#about_table_en .add_about_en', function(){
                ...
                about_html_en += '<td><input type="text" name="en[about_blocks][desc][]" class="form-control" /></td>';
                about_html_en += '<td><input type="text" name="en[about_blocks][link][]" class="form-control" /></td>';
                about_html_en += '<td><input type="text" name="en[about_blocks][link_txt][]" class="form-control" /></td>';
            ...
            /************/
            $(document).on('click', '#faqs_table_ar .add_faqs_ar', function(){
                var faqs_html_ar = '';
                faqs_html_ar += '<tr>';
                faqs_html_ar += '<td><input type="text" name="ar[faqs_blocks][title][]" class="form-control" /></td>';
                faqs_html_ar += '<td><input type="text" name="ar[faqs_blocks][image][]" class="form-control" /></td>';
                faqs_html_ar += '<td><button type="button" class="btn btn-danger btn-sm faqs_remove" style="background: red;"><span class="fa fa-minus"></span></button></td></tr>';
                $('#faqs_table_ar').append(faqs_html_ar);
            });
            $(document).on('click', '#faqs_table_en .add_faqs_en', function(){
                var faqs_html_en = '';
                faqs_html_en += '<tr>';
                faqs_html_en += '<td><input type="text" name="en[faqs_blocks][title][]" class="form-control" /></td>';
                faqs_html_en += '<td><input type="text" name="en[faqs_blocks][image][]" class="form-control" /></td>';
                faqs_html_en += '<td><button type="button" class="btn btn-danger btn-sm faqs_remove" style="background: red;"><span class="fa fa-minus"></span></button></td></tr>';
                $('#faqs_table_en').append(faqs_html_en);
            });
            $(document).on('click', '.faqs_remove', function(){
                $(this).closest('tr').remove();
            });
            /************/
