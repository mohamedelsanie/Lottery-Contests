        ...
        <div class="page-header mb-0">
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('admin.contest.comments.index') }}">{{ __('admin/tour_comment.index.title') }}</a>
                            </li>
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    <a href="{{ route('admin.contest.comments.index') }}" class="btn btn-primary btn-sm scroll-click">
    ...
    <div class="py-12">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                ...
                <form name="restore_all" method="post" action="{{route('admin.contest.comments.restore_all')}}" >
                    @csrf
                                    ...
                                    <td>
                                        <div class="table-actions">
                                            @if(AdminCan('contestcomment-forcedelete'))
                                                ...
                                                <a href="{{ route('admin.contest.comments.restore',$comment->id) }}" data-color="#265ed7"><i class="icon-copy dw dw-cursor-1"></i></a>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
