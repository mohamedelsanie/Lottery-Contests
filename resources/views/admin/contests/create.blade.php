    ...
    <div class="py-12">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                ...
                <form action="{{ route('admin.contests.store') }}" method="post" class="mt-6 space-y-6">
                    @csrf
                            ...
                            <div class="card card-box custom mb-10" id="accordionWork">
                                ...
                                <div id="collapseWork" class="card-body show" data-parent="#accordionWork" >
                                            ...
                                            <div class="tab-content">
                                                @foreach(config('translatable.languages') as $key => $lang)
                                                    <div class="tab-pane @if(LaravelLocalization::getCurrentLocale() == $key) active @endif" id="content-{{ $key }}" role="tabpanel">
                                                        <textarea name="{{ $key }}[content]" placeholder="{{ __('admin/tour.fields.content') }}" class="textarea_editor_{{ $key }} border-gray-300 rounded-md shadow-sm form-control @if($errors->has($key.'*content')) border border-danger @endif">{{ old($key.'.content') }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-md-12">
                                            <input name="num_of" placeholder="{{ __('admin/tour.fields.num_of') }}" value="{{ old('num_of') }}" class="border-gray-300 rounded-md shadow-sm form-control @error('num_of') border border-danger @enderror" type="text"/>
                                            ...
                                            <div class="tab-content">
                                                @foreach(config('translatable.languages') as $key => $lang)
                                                    <div class="tab-pane @if(LaravelLocalization::getCurrentLocale() == $key) active @endif" id="label_text-{{ $key }}" role="tabpanel">
                                                        <input name="{{ $key }}[label_text]" placeholder="{{ __('admin/tour.fields.label_text') }}" value="{{ old($key.'.label_text') }}" class="@if(LaravelLocalization::getCurrentLocale() == $key)  @endif border-gray-300 rounded-md shadow-sm form-control @if($errors->has($key.'*label_text')) border border-danger @endif" type="text"/>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-12 col-md-12 col-form-label">{{ __('admin/tour.fields.label_color') }}</label>
                                        <div class="col-sm-12 col-md-12">
                                            <input name="label_color" placeholder="{{ __('admin/tour.fields.label_color') }}" value="{{ (old('label_color')) ? old('label_color') : '#7ab2fa' }}" class="border-gray-300 rounded-md shadow-sm form-control @error('label_color') border border-danger @enderror" type="text"/>
                        ...
                        <div class="col-sm-12 col-md-4 mb-30">
                            ...
                            <div class="card card-box custom mb-10" id="accordionCategory">
                                <div class="card-header" data-toggle="collapse" href="#collapseCategory">
                                    <a class="card-title">
                                        {{ __('admin/tour.fields.contest_id') }}
                                    </a>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12 col-md-12">
                                            <select name="contest_id" class="border-gray-300 rounded-md shadow-sm custom-select col-12 @error('contest_id') border border-danger @enderror">
                                                <option value="" @if(old('contest_id') == '') selected @endif>{{ __('admin/tour.fields.choose') }}</option>
                                                @foreach($categories as $category)
                                                    <option value="{{ $category->id }}" @if(old('contest_id') == $category->id) selected @endif>{{ $category->title }}</option>
                                                @endforeach
                                            </select>
